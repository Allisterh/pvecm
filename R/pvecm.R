...
#' @param cross_sections A numeric dataframe containing the index for the cross sections.
...
pvecm <- function(right_hand_side, left_hand_side, I_0_dols = NULL, cross_sections, time, dummies = NULL, method = "D", deterministic_long = "none",
                  deterministic_short = "drift", vecm_lags = 2,  kernel = "ba",
